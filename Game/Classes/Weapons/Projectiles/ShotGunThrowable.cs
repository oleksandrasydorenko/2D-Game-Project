...
{
    public class ShotGunThrowable : ProjectileBase
    {
        private AnimationController controller;
        private float rotate = 20;
        private AudioComponent hitSound;
        public ShotGunThrowable(float speed, Vector2 direction, Vector2 position, int damage, int pierceAmount, GameObject origin) : base(speed, direction, position, damage, pierceAmount, origin)
        {
        }
        ...
        public override void Construct()
        {
            ...
            sprite = new Sprite("Game/Assets/Textures/Weapons/LaserShotGun.png", 6);
            ...
            hitbox = new BoxCollider2D(this, 0, 0, 10, 10);
