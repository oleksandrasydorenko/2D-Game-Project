...
{
    public class PlasmaLauncherThrowable : ProjectileBase
    {
        private AnimationController controller;
        private float rotate = 20;
        public PlasmaLauncherThrowable(float speed, Vector2 direction, Vector2 position, int damage, int pierceAmount, GameObject origin) : base(speed, direction, position, damage, pierceAmount, origin)
        {
        }
        ...
        public override void Construct()
        {
            ...
            sprite = new Sprite("Game/Assets/Textures/Weapons/PlasmaLauncher.png", 11);
            ...
            hitbox = new BoxCollider2D(this, 0, 0, sprite.FrameWidth, sprite.FrameHeight);
