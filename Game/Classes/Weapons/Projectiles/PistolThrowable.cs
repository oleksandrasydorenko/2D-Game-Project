...
{
    public class PistolThrowable : ProjectileBase
    {
        private AnimationController controller;
        private float rotate = 20;
        
        public PistolThrowable(float speed, Vector2 direction, Vector2 position, int damage, int pierceAmount, GameObject origin) : base(speed, direction, position, damage, pierceAmount, origin)
        {
        }
        ...
        public override void Construct()
        {
            ...
            sprite = new Sprite("Game/Assets/Textures/Weapons/LaserPistol.png",5);
