...
{
    public class MachineGunThrowable : ProjectileBase
    {
        private AnimationController controller;
        private float rotate = 20;
        public MachineGunThrowable(float speed, Vector2 direction, Vector2 position, int damage, int pierceAmount, GameObject origin) : base(speed, direction, position, damage, pierceAmount, origin)
        {
        }
        ...
        public override void Construct()
        {
            ...
            sprite = new Sprite("Game/Assets/Textures/Weapons/LaserMachineGun.png", 4);
