...
{
    public class SniperThrowable : ProjectileBase
    {
        private AnimationController controller;
        private float rotate = 20;
        private AudioComponent hitSound;
        public SniperThrowable(float speed, Vector2 direction, Vector2 position, int damage, int pierceAmount, GameObject origin) : base(speed, direction, position, damage, pierceAmount, origin)
        {
        }
        ...
        public override void Construct()
        {
            ...
            sprite = new Sprite("Game/Assets/Textures/Weapons/LaserSniper.png", 3);
