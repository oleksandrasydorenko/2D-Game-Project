...
namespace JailBreaker.Ui
{
    ...
    /// </summary>
    public class SceneSelectPanel : UiElement
    {
        ...
        public SceneSelectPanel(float x = 0, float y = 0, string name = "CustomPanel", AnchoringPosition anchor = default) :base(x, y, AnchoringPosition.Center, name)
        {
			//Create character selection buttons
			returnButton = InstanceService.Instantiate(new GameButton());
            firingRangeEditorButton = InstanceService.Instantiate(new GameButton(new Sprite("Game/Assets/Textures/customButton.png"),text: "FiringRange"));
            level3Button = InstanceService.Instantiate(new GameButton(new Sprite("Game/Assets/Textures/customButton.png"),text:"Level 3"));
			level1Button = InstanceService.Instantiate(new GameButton(new Sprite("Game/Assets/Textures/customButton.png"), text: "Level 1"));
			tutorialButton = InstanceService.Instantiate(new GameButton(new Sprite("Game/Assets/Textures/customButton.png"), text: "Tutorial"));
			level2Button = InstanceService.Instantiate(new GameButton(new Sprite("Game/Assets/Textures/customButton.png"), text: "Level 2"));
			customEditorButton = InstanceService.Instantiate(new GameButton(new Sprite("Game/Assets/Textures/customButton.png"), text: "Custom"));
            ...
            text = InstanceService.Instantiate(new UiText(Color.White, "Custom Level can be created in the Editor", 20, -105, -30,AnchoringPosition.Bottom));
        }

        //Event handlers
        public void OnExitButtonClicked()
        {
            MainMenuPanel mp = InstanceService.Instantiate(new MainMenuPanel());
            mp.OnPlayButtonClicked();
            mp = null;
            InstanceService.Destroy(this);
        }
        public void OnTutorialButtonClicked()
        {
			SceneService.LoadSceneByName("Tutorial");
		}
		...
		{
            SceneService.LoadSceneByName("CustomLevel");
		}

        public void OnFiringRangeEditorButtonClicked()
        {
            SceneService.LoadSceneByName("FiringRange");
		}
